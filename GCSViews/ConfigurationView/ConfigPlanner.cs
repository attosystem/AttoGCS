...
namespace MissionPlanner.GCSViews.ConfigurationView
{
    public partial class ConfigPlanner : MyUserControl, IActivate
    {
        ...
        public ConfigPlanner()
        {
            ...
            CMB_Layout.Items.Add(DisplayNames.AttoUserMode);
        ...
        public void Activate()
        {
            ...
            else if (MainV2.DisplayConfiguration.displayName == DisplayNames.AttoUserMode)
            {
        ...
        private void CMB_Layout_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else if ((DisplayNames)CMB_Layout.SelectedItem == DisplayNames.AttoUserMode)
            {
                MainV2.DisplayConfiguration = MainV2.DisplayConfiguration.AttoUserMode();
            }
